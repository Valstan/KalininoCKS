...
1. **Ревизия гейтов #104** (mandate Мозга от 28.07) — не «включён ли гейт», а «что он проверяет» и «видел ли я, как он краснеет». Не начата.
2. **Drizzle-снапшот перед первой миграцией с контентом** (recommend Мозга от 26.07) — дёшево сделать, пока схема маленькая. Не начато.
