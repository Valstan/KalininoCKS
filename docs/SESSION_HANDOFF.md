...
Активной нитки разработки нет. Сайт **калинино-цкс.рф** живёт на проде (Бокс 1, :3006), каркас Next+Payload готов, **ждёт наполнения контентом владельцем** (из ВК) — осознанная пауза by design.

## Что сделано (bootstrap 2026-07-21)

- Проект подключён к экосистеме brain_matrica: `CLAUDE.md`, session-скиллы `/start` + `/close_session`, `mailbox/to-brain/`, `docs/SESSION_HANDOFF.md`. Brain-сторона: `../brain_matrica/mailboxes/KalininoCKS/from-brain/`.
